...
/* Define EVA_[AP]F_LOCAL as portible wrappers for [AP]F_LOCAL. */
#if HAS_PF_LOCAL
#define EVA_PF_LOCAL PF_LOCAL
#define EVA_AF_LOCAL AF_LOCAL
#elif HAS_PF_UNIX
#define EVA_PF_LOCAL PF_UNIX
#define EVA_AF_LOCAL AF_UNIX
#else
...
eva_socket_address_ipv4_class_init (EvaSocketAddressIpv4Class *ipv4_class)
{
  ...
  class->from_native = eva_socket_address_ipv4_from_native;
  class->to_native = eva_socket_address_ipv4_to_native;
  class->to_string = eva_socket_address_ipv4_to_string;
  class->hash = eva_socket_address_ipv4_hash;
  class->equals = eva_socket_address_ipv4_equals;
  eva_socket_address_register_subclass (class);
}
...
eva_socket_address_ipv6_class_init (EvaSocketAddressIpv6Class *ipv6_class)
{
  ...
  class->from_native = eva_socket_address_ipv6_from_native;
  class->to_native = eva_socket_address_ipv6_to_native;
#endif
  class->to_string = eva_socket_address_ipv6_to_string;
  class->hash = eva_socket_address_ipv6_hash;
  class->equals = eva_socket_address_ipv6_equals;
  eva_socket_address_register_subclass (class);
}
			              ...
			              gsize             sockaddr_length)
{
  ...
  gint max_len;
  guint len;
  if (EVA_STRUCT_IS_LAST_MEMBER (struct sockaddr_un, sun_path))
  ...
  g_free (local->path);
  len = eva_strnlen (native->sun_path, max_len);
...
eva_socket_address_local_class_init (EvaSocketAddressLocalClass *class)
{
  ...
  address_class->address_family = EVA_AF_LOCAL;
  address_class->protocol_family = EVA_PF_LOCAL;
  address_class->to_native = eva_socket_address_local_to_native;
  address_class->from_native = eva_socket_address_local_from_native;
  address_class->to_string = eva_socket_address_local_to_string;
  address_class->equals = eva_socket_address_local_equals;
  address_class->hash = eva_socket_address_local_hash;
  eva_socket_address_register_subclass (address_class);
  object_class->finalize = eva_socket_address_local_finalize;
}

/**
 * eva_socket_address_local_new:
...
#if 0
  class->to_native = eva_socket_address_ethernet_to_native;
  class->from_native = eva_socket_address_ethernet_from_native;
...
/**
 * eva_socket_address_from_native:
				  ...
				  gsize         native_size)
{
  ...
  rv = EVA_SOCKET_ADDRESS (rv_object);
  class = EVA_SOCKET_ADDRESS_GET_CLASS (rv);
...
/**
 * eva_socket_address_sizeof_native:
...
/**
 * eva_socket_address_address_family:
 * @address: a socket address.
 *
			     ...
			     guint16       port)
{
  ...
  return EVA_SOCKET_ADDRESS (ipv4);
}
				  ...
				  gconstpointer     address_b_ptr)
{
  ...
  if (type_a != type_b)
    return FALSE;
  class = EVA_SOCKET_ADDRESS_GET_CLASS (address_a);
...
/* --- protected methods --- */
/**
 * eva_socket_address_register_subclass:
...
GQuark 
eva_socket_address_get_remote_quark()
{
  static GQuark rv = 0;
  if (rv == 0)
    rv = g_quark_from_static_string ("eva-socket-address-remote-quark");
  return rv;
}

GQuark 
eva_socket_address_get_local_quark()
{
  static GQuark rv = 0;
  if (rv == 0)
    rv = g_quark_from_static_string ("eva-socket-address-local-quark");
  return rv;
}
