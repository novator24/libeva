...
#define EVA_HTTP_REQUEST(obj)              (G_TYPE_CHECK_INSTANCE_CAST ((obj), EVA_TYPE_HTTP_REQUEST, GskHttpRequest))
#define EVA_HTTP_REQUEST_CLASS(klass)      (G_TYPE_CHECK_CLASS_CAST ((klass), EVA_TYPE_HTTP_REQUEST, GskHttpRequestClass))
#define EVA_HTTP_REQUEST_GET_CLASS(obj)    (G_TYPE_INSTANCE_GET_CLASS ((obj), EVA_TYPE_HTTP_REQUEST, GskHttpRequestClass))
...
/* --- cookies --- */
void            eva_http_request_add_cookie      (GskHttpRequest *header,
                                                  GskHttpCookie  *cookie);
void            eva_http_request_remove_cookie   (GskHttpRequest *header,
                                                  GskHttpCookie  *cookie);
GskHttpCookie  *eva_http_request_find_cookie     (GskHttpRequest *header,
                                                  const char     *key);

void eva_http_request_set_cache_control (GskHttpRequest               *request,
                                         GskHttpRequestCacheDirective *directive);

gboolean        eva_http_request_has_content_body (GskHttpRequest *request);

/* request specific functions */
/* unhandled: if_match */
void            eva_http_request_add_charsets            (GskHttpRequest *header,
                                                          GskHttpCharSet *char_sets);
void            eva_http_request_clear_charsets          (GskHttpRequest *header);
void            eva_http_request_add_content_encodings   (GskHttpRequest *header,
                                                          GskHttpContentEncodingSet *set);
void            eva_http_request_clear_content_encodings (GskHttpRequest *header);
void            eva_http_request_add_transfer_encodings  (GskHttpRequest *header,
                                                          GskHttpTransferEncodingSet *set);
void            eva_http_request_clear_transfer_encodings(GskHttpRequest *header);
void            eva_http_request_add_media               (GskHttpRequest *header,
                                                          GskHttpMediaTypeSet *set);
void            eva_http_request_clear_media             (GskHttpRequest *header);
void            eva_http_request_set_authorization       (GskHttpRequest  *request,
...
GskHttpRequest *eva_http_request_new                     (GskHttpVerb  verb,
						          const char  *path);
...
#define eva_http_request_set_verb(request, verb)	\
    g_object_set(EVA_HTTP_REQUEST(request), "verb", (GskHttpVerb)(verb), NULL)
