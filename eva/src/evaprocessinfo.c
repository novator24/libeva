...
const char *eva_process_info_state_name (EvaProcessInfoState state)
{
  switch (state)
    {
    case EVA_PROCESS_INFO_RUNNING:
      return "running";
    case EVA_PROCESS_INFO_SLEEPING:
      return "sleeping";
    case EVA_PROCESS_INFO_DISK:
      return "disk-wait";
    case EVA_PROCESS_INFO_ZOMBIE:
      return "zombie";
    case EVA_PROCESS_INFO_TRACED:
      return "traced";
    case EVA_PROCESS_INFO_PAGING:
      return "paging";
    default:
