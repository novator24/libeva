...
int main (int argc, char **argv)
{
  ...
  g_assert (EVA_HOOK_TEST_IS_AVAILABLE (TEST_HOOK_OBJECT_HOOK (object1)));
  g_assert (!EVA_HOOK_TEST_IDLE_NOTIFY (TEST_HOOK_OBJECT_HOOK (object1)));
  g_assert (!EVA_HOOK_TEST_NEVER_BLOCKS (TEST_HOOK_OBJECT_HOOK (object1)));
