...
int main()
{
  ...
  context = eva_compile_context_new ();
  eva_compile_context_set_verbose (context, TRUE);
  module = eva_module_compile (context, 1, &name, 0,
  ...
  func = eva_module_lookup (module, "stupid_factorial");
  g_assert (func != NULL);
  g_assert (func(1) == 1);
  g_assert (func(2) == 2);
  g_assert (func(3) == 6);
