  ...
  if (readable || writable)
    {
      ...
      iter_data->events[cur_num].type = EVA_MAIN_LOOP_EVENT_IO;
...
static void
eva_main_loop_select_finalize (GObject *object)
{
...
eva_main_loop_select_class_init (GskMainLoopPollBaseClass *class)
{
  ...
  class->config_fd = eva_main_loop_select_config_fd;
  class->do_polling = eva_main_loop_select_do_polling;
}


GType eva_main_loop_select_get_type()
{
