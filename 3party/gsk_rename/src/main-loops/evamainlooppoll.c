...
static void eva_main_loop_poll_class_init (EvaMainLoopPollBaseClass* class)
{
  ...
  class->config_fd = eva_main_loop_poll_config_fd;
  class->do_polling = eva_main_loop_poll_do_polling;
  object_class->finalize = eva_main_loop_poll_finalize;
}

GType eva_main_loop_poll_get_type()
{
